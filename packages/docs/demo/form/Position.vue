...
<template>
  ...
  <wz-form :model="form" :label-position="labelPosition">
    <wz-form-item label="Activity name">
      <wz-input v-model="form.name" />
    </wz-form-item>
    <wz-form-item label="Activity zone">
      <wz-select
        v-model="form.region"
